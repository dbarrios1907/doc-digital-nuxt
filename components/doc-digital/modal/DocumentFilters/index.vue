...
export default {
  ...
  methods: {
    cancel() {
      this.d_tema = undefined
      this.d_tipo = undefined
      this.d_folio = undefined
      this.d_createdStart = undefined
      this.d_createdEnd = undefined
      this.d_updatedStart = undefined
      this.d_updatedEnd = undefined
      this.$emit('onCancel')
    },
    filter() {
