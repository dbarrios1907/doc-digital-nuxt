...
@include theme-wrap('.section') using ($material) {
  $secondary-color: map-deep-get($material, 'section', 'colors', 'secondary-light');
...
@include theme-wrap('.badge-number') using ($material) {
