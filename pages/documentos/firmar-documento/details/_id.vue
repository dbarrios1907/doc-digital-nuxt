      ...
      <v-col cols="12" class="px-13 py-9 bg-grey1">
        <v-row>
          <v-col cols="6" class="my-auto"
            ><div class="weight-700 font-25 line-height-31 font-robotoslab">Información general del documento</div></v-col
          >
        ...
        <v-row>
          <v-col cols="4">
            ...
            <v-dialog overlay-opacity="0.55" overlay-color="#001C41" v-model="dialog" max-width="960px" :content-class="ismobil">
              <v-card>
                <v-card-title>
