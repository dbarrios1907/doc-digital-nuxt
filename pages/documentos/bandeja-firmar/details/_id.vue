...
<div class="mt-7">
    ...
    <dx-collapse :items="itemscollapse" @currentPanel="gotPanelData" />
        ...
        <v-card>
            ...
            <v-card-text class="font-roboto weight-400 line-height-30 font-title darken3--text py-10 px-10">
                ...
                <div>
                    ...
                    <v-textarea v-model="rechazo" no-resize rows="4" outlined :value="rechazo" :maxlength="limitmaxCount" @input="updatefield('rechazo', $event)">
...
export default {
    ...
    data: () => ({
        ...
        itemscollapse: [{
            ...
            {
                id: 3,
                tipoTarea: 'FOLIO_DESPACHO',
                title: '4. Folio y despacho',
                description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore         magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
            },
            {
                id: 4,
                tipoTarea: 'DESTINATARIOS',
                title: '5. Destinatarios',
                description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore         magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
            },
        ],
    ...
    methods: {
        ...
        gotPanelData(panel) {
          console.log(panel)
            try {
                if (panel != 'undefined') {
                    const panelIndex = this.itemscollapse.findIndex(obj => obj.id == panel)
                    const tipoTarea = this.itemscollapse[panelIndex].tipoTarea

                    let resp = this.$store.dispatch('documentos/loadDocumentTask', {
                        tipoTarea,
                        usuario: 1
                    })
                }
