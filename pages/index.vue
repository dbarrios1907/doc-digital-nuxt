  ...
  <div>
    ...
    <v-row no-gutters>
      <v-col class="pr-md-5">
        ...
        <SectionPending v-if="hasNotifications" :visar="pedientesVisar" :firmar="pendientesFirmar" :recibir="pendientesOpRecibir" />
...
export default {
  computed: {
    hasNotifications() {
      return this.pedientesVisar > 0 || this.pendientesOpRecibir > 0 || this.pendientesFirmar > 0
    },
    ...mapGetters(['userName']),
